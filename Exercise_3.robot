...
Testing Sum
    Sum    1    ${number_2}    3    4    ${number_5}

Testing Subtraction
    Subtraction    0    0    0

Testing Division
    Run Keyword And Continue On Failure    Division    5    4
    Run Keyword And Continue On Failure    Division    8    0
    Run Keyword And Continue On Failure    Division    7    2
...
Testing List
    ...
    Log Many    @{list}
    Log    2nd element of list is @{list}[1]
